  ...
  function P(b, d) {
      ...
      return (
        ...
        d.forEach(function (a, f) {
          ...
          if (('steps' === c && (h = aa.xNumSteps[f]), h || (h = v - u), u !== !1 && void 0 !== v))
            for (i = u; v >= i; i = e(i, h)) {
              for (n = aa.toStepping(i), o = n - l, r = o / b, s = Math.round(r), t = o / s, m = 1; s >= m; m += 1)
    ...
    function y(a, b, c) {
      ...
      function g(a, d) {
        aa.direction && (a = 100 - a),
          ...
          d[1] && (k += '<div ' + f(a, da[22], d) + '>' + c.to(d[0]) + '</div>');
      }
    ...
    function H(a, b) {
      ...
      var d = D(R.move, c, E, {
        ...
        e = D(R.end, c, F, { handles: b.handles, handleNumber: b.handleNumber }),
    ...
    function I(a) {
      ...
      return (
        ...
        Y[b].hasAttribute('disabled')
          ? !1
          : (L(Y[b], e), B('slide', b, !0), B('set', b, !0), B('change', b, !0), void (d.events.snap && H(a, { handles: [Y[b]] })))
      );
    }
    function J(a) {
    ...
    function K(a) {
      var b, c;
      if (!a.fixed) for (b = 0; b < Y.length; b += 1) D(R.start, Y[b].children[0], H, { handles: [Y[b]], handleNumber: b });
    ...
    function L(a, b, c) {
      ...
      return (
        ...
        c !== !1 && d.limit && Y.length > 1 && (b = e ? Math.min(b, i) : Math.max(b, l)),
        (b = aa.getStep(b)),
      ...
      for (d.limit && (a += 1), c = 0; a > c; c += 1)
        (e = c % 2),
          ...
          null !== f &&
            ...
            (f = d.format.from(f)),
            (f === !1 || isNaN(f) || L(Y[e], aa.toStepping(f), c === 3 - d.dir) === !1) && B('update', e));
    }
    function N(a) {
      var b,
        c,
    ...
    return (
      ...
      d.pips && z(d.pips),
      d.tooltips && v(),
      (Z = { destroy: Q, steps: T, on: U, off: V, get: P, set: N, updateOptions: W, options: d, target: $, pips: z }),
      K(d.events),
      Z
    );
  }
